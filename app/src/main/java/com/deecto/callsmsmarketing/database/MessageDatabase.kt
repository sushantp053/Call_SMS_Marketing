...
@Database(entities = arrayOf(Message::class, PhoneCall::class, DaySMSCounter::class, WhatsappMessage::class, DayWhatsappCounter::class), version = 1, exportSchema = false)
